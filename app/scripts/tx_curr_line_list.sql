...
DATEDIFF(DATE_ADD(MAX(obs.obs_datetime),INTERVAL getconceptval(getmaxconceptobsidwithformid(obs.person_id,162240,27,@endDate),159368,obs.person_id) DAY), NOW()) >=-28 AS 'Tx_no',
